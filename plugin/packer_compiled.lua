...
_G.packer_plugins = {
  ...
  catppuccin = {
    loaded = true,
    path = "/home/nealwp/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  cmp_luasnip = {
    loaded = true,
    path = "/home/nealwp/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
  ...
  playground = {
    ...
    loaded = true,
    needs_bufread = true,
    path = "/home/nealwp/.local/share/nvim/site/pack/packer/opt/playground",
